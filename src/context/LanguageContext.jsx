...
const content = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Your trusted partner in digital transformation. Comprehensive IT solutions from foundational infrastructure to cutting-edge AI and Cloud technologies.",
      ...
      reasons: [
        {
          ...
          description: "Deep understanding of the Saudi Arabian market, regulatory landscape, and business culture."
        },
        {
          title: "Comprehensive Solutions",
          description: "A single partner for all IT needs, from foundational setup to advanced digital transformation."
        },
        {
          title: "Client-Centric Approach",
          description: "Tailored solutions designed to meet the unique goals and challenges of each client."
        },
        {
          title: "Innovation-Driven",
          description: "Committed to bringing the latest technologies and best practices to our clients."
        },
        {
          title: "Reliability & Support",
          description: "Dedicated to providing consistent, high-quality service and support."
        },
        {
          title: "Vision 2030 Aligned",
          description: "Our services support the national agenda for digital economic growth."
        }
      ]
    },
    contact: {
    ...
    footer: {
      ...
      copyright: "© 2026 IT Services SA. All rights reserved. Aligned with Vision 2030."
    }
  },
  ar: {
    header: {
    ...
    hero: {
      ...
      subtitle: "شريكك الموثوق في التحول الرقمي. حلول تقنية معلومات متكاملة تبدأ من البنية التحتية الأساسية وصولاً إلى تقنيات الذكاء الاصطناعي والسحابية المتقدمة.",
    ...
    mainServices: {
      ...
      subtitle: "من البنية التحتية الأساسية إلى التحول الرقمي المتقدم، نغطي كافة جوانب احتياجاتك التقنية.",
      servicesList: {
        infra: {
    ...
    whyUs: {
      ...
      reasons: [
        {
          title: "خبرة محلية",
          description: "فهم عميق للسوق السعودي، والبيئة التنظيمية، وثقافة الأعمال المحلية."
        },
        {
          title: "حلول شاملة ومتكاملة",
          description: "شريك واحد لجميع احتياجات تقنية المعلومات، بدءاً من التأسيس الأولي وحتى التحول الرقمي المتقدم."
        },
        {
          title: "التركيز على العميل",
          description: "حلول مخصصة مصممة لتلبية الأهداف والتحديات الفريدة لكل عميل."
        },
        {
          title: "الابتكار المستمر",
          description: "نلتزم بتقديم أحدث التقنيات وأفضل الممارسات العالمية لعملائنا."
        },
        {
        ...
        },
        {
          ...
          description: "تدعم خدماتنا الأجندة الوطنية للنمو الاقتصادي الرقمي للمملكة."
        }
      ]
    },
    contact: {
      title: "هل أنت جاهز لتحويل أعمالك رقمياً؟",
      subtitle: "تواصل معنا اليوم للحصول على استشارة مخصصة واكتشف كيف يمكن لحلولنا التقنية الخبيرة أن تدفع نجاحك.",
      ctaTouch: "تواصل معنا",
    ...
    footer: {
      ...
      copyright: "© 2026 جميع الحقوق محفوظة لشركة خدمات تقنية المعلومات SA. متوافق مع رؤية 2030."
    }
  }
};
